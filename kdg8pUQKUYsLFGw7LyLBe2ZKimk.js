...
return false}}());CloudflareApps.installs["fsMBr6puqm5b"]={appId:"mKZRW4xoYN4A",scope:{}};;CloudflareApps.installs["fsMBr6puqm5b"].options={"advanced":{"location":"body","minHeight":2,"minWidth":2},"opacity":50,"position":"center","showAdvanced":true,"text":"","textColor":"#ffffff","textSize":"24"};;CloudflareApps.installs["fsMBr6puqm5b"].URLPatterns=["^perantiguru.com/?.*$"];;CloudflareApps.installs["fsMBr6puqm5b"].selectors={"advanced.location":"body"};;CloudflareApps.installs["fsMBr6puqm5b"].product={"id":"plus"};;if(CloudflareApps.matchPage(CloudflareApps.installs['fsMBr6puqm5b'].URLPatterns)){(function webpackUniversalModuleDefinition(root,factory){if(typeof exports==='object'&&typeof module==='object'){module.exports=factory();}else if(typeof define==='function'&&define.amd){define([],factory);}else if(typeof exports==='object'){exports["watermark"]=factory();}else{root["watermark"]=factory();}})(this,function(){return(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId])
...
var shared=CanvasPool();exports.default=shared;}])});;};if(CloudflareApps.matchPage(CloudflareApps.installs['fsMBr6puqm5b'].URLPatterns)){(function(){'use strict'
if(!window.MutationObserver||!window.Promise)return
var watermark=window.watermark
var SRCSET_PATTERN=new RegExp(',\\s')
var options=CloudflareApps.installs['fsMBr6puqm5b'].options
var observer=null
var container=null
...
function bootstrap(){document.body.setAttribute('data-cf-watermark-mode',"fsMBr6puqm5b"==='preview'?'preview':'live')
container=document.querySelector(options.advanced.location)
if(!container)return
parseDOM()
observeElements()}
if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',bootstrap)}else{bootstrap()}
window.CloudflareApps.installs['fsMBr6puqm5b'].scope={setOptions:function(nextOptions){clearTimeout(updateTimeout)
options=nextOptions
